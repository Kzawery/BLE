...
class ScanActivity : AppCompatActivity()  {
    ...
    private fun showAlertDialog() {
        val alertDialog: AlertDialog.Builder = AlertDialog.Builder(this@ScanActivity)
        //alertDialog.setTitle("AlertDialog")
        alertDialog.setMessage("Czy napewno chcesz dokonać przelewu na " + amount + "zł do Adam Kowalski?" )
        alertDialog.setPositiveButton(
            "Tak"
        ) { _, _ ->
            Toast.makeText(this@ScanActivity, "Zlecono przelew.", Toast.LENGTH_LONG).show()
        }
    ...
    private fun setupRecyclerView() {
        ...
        //scan_results_recycler_view.adapter = Adapter(this, this)
